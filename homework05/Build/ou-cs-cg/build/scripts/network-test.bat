...
@rem ##########################################################################
@rem
@rem  network-test startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and NETWORK_TEST_OPTS to pass JVM options to this script.
...
@rem Execute network-test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NETWORK_TEST_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.interaction.Network %CMD_LINE_ARGS%
...
:fail
rem Set variable NETWORK_TEST_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%NETWORK_TEST_EXIT_CONSOLE%" exit 1
exit /b 1
