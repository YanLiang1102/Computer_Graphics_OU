...
public final class KeyHandler extends KeyAdapter
{
	...
	public void		keyPressed(KeyEvent e)
	{
		...
		if(a==0.01)
		{
        	...
        	{
       		  //view.scaleNode("height");
        		view.counterclockwise=false;
        		 view.rotatex=(view.rotatex+360.0f/20.0f);
        	}
		...
		else
		{
						switch (e.getKeyCode())
				{
				    ...
				    case KeyEvent.VK_J:
				    view.br=view.br*0.9f;
				    break;
				    case KeyEvent.VK_T:
				    view.zoom=view.zoom*1.1f;
				    break;
				    case KeyEvent.VK_R:
				    view.zoom=view.zoom*0.5f;
				    break;
				    case KeyEvent.VK_Z:
				    view.counterclockwise=true;
				    view.rotatex=(view.rotatex+360.0f/20.0f);
				    break;
				    case KeyEvent.VK_H:
				    view.layoutLine();
				    break;
				    // case KeyEvent.VK_Y:
				    // view.rotatey=(view.rotatey+2.0f*3.14f/10.0f)%3.14;
				    // break;
