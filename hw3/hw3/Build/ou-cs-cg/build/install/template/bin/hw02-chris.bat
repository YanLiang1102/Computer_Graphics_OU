...
@rem ##########################################################################
@rem
@rem  hw02-chris startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and HW02_CHRIS_OPTS to pass JVM options to this script.
...
@rem Execute hw02-chris
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HW02_CHRIS_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.homework.Homework02Chris %CMD_LINE_ARGS%
...
:fail
rem Set variable HW02_CHRIS_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%HW02_CHRIS_EXIT_CONSOLE%" exit 1
exit /b 1
